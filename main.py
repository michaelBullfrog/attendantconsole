...
def format_zoho_datetime(value: Any) -> Optional[str]:
    ...
    Zoho CRM accepts DateTime values such as 2021-02-23T13:30:00+05:30.
    Webex call logs are stored with microseconds, which Zoho may reject.
    """
    if not value:
        return None
...
def format_zoho_call_duration(duration_seconds: int) -> str:
    """Return Zoho Calls duration in HH:mm format, rounded up to at least 1 minute."""
