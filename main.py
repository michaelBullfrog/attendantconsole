...
# Rev.io PSA API key support. Rev.io/API Management keys commonly use
# Ocp-Apim-Subscription-Key with no Authorization scheme. Override these
# variables if your Rev.io tenant provides a different header format.
# Default sends: Ocp-Apim-Subscription-Key: <api_key>
