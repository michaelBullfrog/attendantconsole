...
<main>
  ...
  <div class="note">
    Org names use GET /v1/organizations/{orgId}. Add spark-admin:organizations_read to the Webex Integration and reauthorize, or set WEBEX_ADMIN_TOKEN / WEBEX_ORG_NAME_MAP in Render.
  </div>
</main>
