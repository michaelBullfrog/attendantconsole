      ...
      <div class="call-log-item">
        ...
        <div>
          ...
          <div class="action-line zoho-line">
            ...
            <button class="small zoho-button" ${zohoDisabled ? "disabled" : ""} title="Send to Zoho as Inbound" onclick="sendCallLogToZoho(${log.id}, 'Inbound')">Zoho Inbound</button>
            <button class="small zoho-button outbound" ${zohoDisabled ? "disabled" : ""} title="Send to Zoho as Outbound" onclick="sendCallLogToZoho(${log.id}, 'Outbound')">Zoho Outbound</button>
          </div>
